...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( Map<String, CartItem> items)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CartState() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( Map<String, CartItem> items)  $default,) {final _that = this;
switch (_that) {
case _CartState():
return $default(_that.items);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( Map<String, CartItem> items)?  $default,) {final _that = this;
switch (_that) {
case _CartState() when $default != null:
return $default(_that.items);case _:
  return null;
...
class _CartState extends CartState {
  const _CartState({final  Map<String, CartItem> items = const {}}): _items = items,super._();
